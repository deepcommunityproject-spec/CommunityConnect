...
SECRET_KEY = 'django-insecure-7x4^=b^c74^*3@xefhm3w-=ak8@biv*25047as39aq)3)1@ang'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['volunteerconnect.pythonanywhere.com']
...
SENDGRID_SANDBOX_MODE_IN_DEBUG = False # Disable sandbox even in Debug mode
